...
```jsx 45:62 file="./codeblocks/react-rxjs/09_1delay-ccy-rates.tsx"
```

```diff 82
```

```jsx 64:71,91 file="./codeblocks/react-rxjs/09_2delay-ccy-rates.tsx"
```

```diff 57
```

```jsx 57:68 file="./codeblocks/react-rxjs/09_3delay-ccy-rates.tsx"
```

```jsx 69:83 file="./codeblocks/react-rxjs/09_4delay-ccy-rates.tsx"
```

```jsx 85:93 file="./codeblocks/react-rxjs/09_5delay-ccy-rates.tsx"
```

```jsx 95:98 file="./codeblocks/react-rxjs/09_6delay-ccy-rates.tsx"
```
</NotesCodeSurfer>
