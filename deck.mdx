...
Well, if I had to draw a diagram that represents how our components are being
composed, that diagram would look more or less like this:

Let's call this the "view tree. Here at the top we have...

However, if I have to draw a diagram that represents how our state is being
composed, then that diagram would look more or less like this:
</Notes>
