...
```jsx 105,108:110 file="./codeblocks/react-rxjs/04_2orderLinePriceCurrency.tsx"
```
...
```jsx 113 file="./codeblocks/react-rxjs/08_perf.tsx"
```
...
### Async currency rates validation
---
### React-RxJs implementation
---

<NotesCodeSurfer>

```jsx 21:24 file="./codeblocks/react-rxjs/08_perf.tsx"
```

```jsx 52:69 file="./codeblocks/react-rxjs/09_0delay-ccy-rates.tsx"
```

```diff 109:124
```

```jsx 109:131 file="./codeblocks/react-rxjs/09_1delay-ccy-rates.tsx"
```

```diff 89
```

```jsx 71:78,98 file="./codeblocks/react-rxjs/09_2delay-ccy-rates.tsx"
```

```diff 64
```

```jsx 64:76 file="./codeblocks/react-rxjs/09_3delay-ccy-rates.tsx"
```

```jsx 77:79 file="./codeblocks/react-rxjs/09_4delay-ccy-rates.tsx"
```

```jsx 79:87 file="./codeblocks/react-rxjs/09_5delay-ccy-rates.tsx"
```

```jsx 88:96 file="./codeblocks/react-rxjs/09_6delay-ccy-rates.tsx"
```

```notes checkout:react-rxjs/9
asdf
```

```jsx 97 file="./codeblocks/react-rxjs/09_7delay-ccy-rates.tsx"
```
...
```jsx 77:109 file="./codeblocks/react-rxjs/09_8delay-ccy-rates.tsx"
```
...
```jsx 97:115 file="./codeblocks/react/10_calculateTotal.tsx"
```

```notes checkout:react-local-state/12
asdf
```

```jsx 110:139 file="./codeblocks/react/11_delay-currency-rate.tsx"
````
...
```jsx 50:64 file="./codeblocks/react-rxjs/09_8delay-ccy-rates.tsx"
```

```notes checkout:react-rxjs/10
asdf
```

```jsx 53,72,73 file="./codeblocks/react-rxjs/10_cancelation.tsx"
```
...
```notes checkout:react-local-state/14
asdf
```

```jsx 112,120:125,147 file="./codeblocks/react/12_cancelation.tsx"
```
